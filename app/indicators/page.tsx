...
export default function IndicatorsPage(){
 ...
 const rows=useMemo(()=>{
   if(!data)return [];
   const getValue=(c:IndicatorCoin)=>sort==="oi"?c.oi.h4:sort==="io"?c.flows.h4?.net:sort==="cap"?c.oiCapPct:sort==="volume"?c.flows.h24?.total:sort==="strength"?c.strengthScore:c.earlyScore;
